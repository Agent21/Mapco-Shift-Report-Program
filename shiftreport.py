...
def main():
    ...
    try:
        if file_write_req.lower() in ("yes", "ye", "y"):
            ...
            outfile.write('\n')
            outfile.write("Beginning safe products")
            outfile.write('\n')
            outfile.write('\n'.join('Slot #{0}: {1}'.format(*k) for k in enumerate(beginning_prod, 1)))
            outfile.write('\n')
            outfile.write('Beginning safe total: $' + format(beginning_safe_total, ',.2f'))
            outfile.write('\n\n')
            outfile.write("Ending tube QTY")
            outfile.write('\n')
            outfile.write('\n'.join('Slot #{0}: {1}'.format(*k) for k in enumerate(ending_qty, 1)))
            outfile.write('\n')
            outfile.write("Ending safe products")
            outfile.write('\n')
            outfile.write('\n'.join('Slot #{0}: {1}'.format(*k) for k in enumerate(ending_prod, 1)))
            outfile.write('\n')
            outfile.write('Ending safe total: $' + format(ending_safe_total, ',.2f'))
            outfile.write('\n\n')
            ...
            for reg_slot_values in beginning_reg:
                ...
                outfile.write('\n')
            outfile.write('\n')
            outfile.write('Beginning register subtotal: $' + format(b_reg_subtotal, ',.2f'))
            outfile.write('\n')
            outfile.write('Beginning safe ledge: $' + format(beginning_ledge, ',.2f'))
            outfile.write('\n')
            outfile.write('Beginning register total: $' + format(beginning_reg_total, ',.2f'))
            outfile.write('\n\n')
            ...
            for reg_slot_values in ending_reg:
                ...
                outfile.write('\n')
            outfile.write('\n\n')
            outfile.write('Ending register subtotal: $' + format(e_reg_subtotal, ',.2f'))
            outfile.write('\n')
            outfile.write('Ending safe ledge: $' + format(ending_ledge, ',.2f'))
            outfile.write('\n')
            outfile.write('Ending register total: $' + format(ending_reg_total, ',.2f'))
            outfile.write('\n\n')
            outfile.write('----SAFE DROPS----')
            outfile.write('\n\n')
            outfile.write('\n'.join('Drop #{0}: {1}'.format(*k) for k in enumerate(safe_drop_list, 1)))
            outfile.write('\n')
            outfile.write('Total drops: $' + format(total_drops, ',.2f'))
            outfile.write('\n')
            outfile.write('Beginning count: $' + format(beginning_count, ',.2f'))
            outfile.write('\n')
            outfile.write('Ending count: $' + format(ending_count, ',.2f'))
            outfile.write('\n\n')
            outfile.write('Total cash: $' + format(total_cash, ',.2f'))
            outfile.write('\n')
            outfile.write('EBT: $' + format(ebt, ',.2f'))
            outfile.write('\n')
            outfile.write('Credit cards: $' + format(credit_cards, ',.2f'))
            outfile.write('\n')
            outfile.write('Total coupons: $' + format(coupons, ',.2f'))
            outfile.write('\n')
            outfile.write('Total lottery paid outs: $' + format(lottery_paid_outs, ',.2f'))
            outfile.write('\n')
            outfile.write('Total money: $' + format(subtotal, ',.2f'))
            outfile.write('\n')
            outfile.write('Total sales: $' + format(total_reg_sales, ',.2f'))
            outfile.write('\n')
            outfile.write('Cash over/short: $' + format(cash_over_short, ',.2f'))
